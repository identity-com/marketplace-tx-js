...
To ensure your tests pass, your code follows the formatting and style guides, and
your PR does not reduce the code coverage, run `npm run check`.
...
# Prerequisites
Please follow [README](README.md) and [DEVELOPER_GUIDE](DEVELOPER_GUIDE.md) instructions.
